...
startGame.addEventListener('click', function(){
    ...
    function throwDice(){
        ...
        game.innerHTML += `<img src="images/${gameData.dice[gameData.roll1]}"><img src="images/${gameData.dice[gameData.roll2]}">`;
        ...
        if(gameData.rollSum == 2){
            ...
            actionArea.innerHTML = '<button id="roll">Roll Again</button> or <button id="pass">Pass</button>';
            document.querySelector('#rollagain1').addEventListener('click', function(){
                throwDice();
            });
    ...
    function showCurrentScore(){
       ...
       document.addEventListener("DOMContentLoaded", () => {
        ...
        const boxedText = document.querySelector(".boxed-text").innerText;
    
        ttsButton.addEventListener("click", () => {
            // Stop any current speech
            window.speechSynthesis.cancel();
    
            const speech = new SpeechSynthesisUtterance(boxedText);
            speech.lang = "en-US";
